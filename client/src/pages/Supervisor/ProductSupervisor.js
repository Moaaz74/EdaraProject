  ...
  return (
    <div className="warehouse-container">
      ...
      <tbody>
        ...
        <tr>
          <td style={{width:"8%"}}><img src="" alt="ProductPhoto" className="product-photo"/></td>
          ...
          <td>
            ...
            <Link  className="btn btn-sm btn-primary mx-2">Update</Link>
...
export default ProductSupervisor